...
int main(int argc, char *argv[]){
    ...
    while (episode < learning_episodes){
        ...
        s_alpha = s_alpha0;     
        s_theta = find_state(theta, thetas);
        s_vtheta = find_state(vtheta, thetas_vel);
        ...
        while (rk[1] > 0){
            ...
            if (it%decision_time == 0){
                ...
                s_theta1 = find_state(theta, thetas);
                s_vtheta1 = find_state(vtheta, thetas_vel);
